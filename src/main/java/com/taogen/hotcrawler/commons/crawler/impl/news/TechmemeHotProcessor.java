...
public class TechmemeHotProcessor implements HotProcessor
{
    private static final Logger log = LoggerFactory.getLogger(TechmemeHotProcessor.class);

    @Autowired
    private BaseHotProcessor baseHotProcessor;

    public static final String DOMAIN = "https://www.techmeme.com";
    public static final String HOT_PAGE_URL = "https://www.techmeme.com";
